...
('33333333-0000-0000-0000-000000000003', 'CC', '4004004004', 'Ana', 'Martinez', '1975-03-25', 
 76001, false, false, null, 'SUSPENDIDO', 'Condena penal', 
 'ana.martinez@example.com', 'hash_falso_123', 'CIUDADANO', false, NOW(), NOW());

-- Insertar Censo Electoral Snapshot para Lugar de Votacion
INSERT INTO censo_electoral_snapshot (eleccion_id, ciudadano_id, puesto_asignado_id) VALUES 
('eeeeeeee-0000-0000-0000-000000000001', '11111111-0000-0000-0000-000000000001', 'dddddddd-0000-0000-0000-000000000001'),
('eeeeeeee-0000-0000-0000-000000000001', '22222222-0000-0000-0000-000000000002', 'dddddddd-0000-0000-0000-000000000001');

-- Insertar Jurado (Maria va a ser jurado)
INSERT INTO jurado (id, eleccion_id, ciudadano_id, mesa_id) VALUES 
('aaaaaaaa-0000-0000-0000-000000000001', 'eeeeeeee-0000-0000-0000-000000000001', '22222222-0000-0000-0000-000000000002', 'bbbbbbbb-0000-0000-0000-000000000001');
